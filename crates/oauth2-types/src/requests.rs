...
#[derive(Debug, Hash, PartialEq, Eq, PartialOrd, Ord, Clone, Display, FromStr)]
...
impl_de_serialize_from_str_display!(ResponseMode);
...
impl_de_serialize_from_str_display!(Display);
...
impl_de_serialize_from_str_display!(Prompt);
...
#[derive(Debug, Hash, PartialEq, Eq, PartialOrd, Ord, Clone, Copy, Display, FromStr)]
#[display(style = "snake_case")]
pub enum GrantType {
